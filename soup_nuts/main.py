...
def preprocess(
    ...
    save_json(terms, Path(output_dir, "vocab.json"), indent=2)   # mapping words to keys

    # creates, for each split,
    # - a sparse matrix (documents as bag of words)
    # - a jsonl containing metadata (at the very least, ids), one row per document
